...
units_subset=units%>%filter(curriculum_name %in% programs) %>%
  ...
  select(1, 29, 2:28) ##rearrange the columns

###The following three regression models shows total units can be very well 
####predicted by the number of active students. Number of active students, on the other hand,
### maybe predicted by enrolled students in previous semesters.
